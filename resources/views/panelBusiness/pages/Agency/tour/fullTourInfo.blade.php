            ...
            <div class="infoSections">
                    ...
                    <div id="infoBody_1" class="infoBody show">
                        <div class="row infoRow">
                            ...
                            <div class="col-md-3 infoSec">
                                ...
                                <div id="tourPublishStatusText" class="infoVal" style="color: {{$tour->statusCode == 0 ? '#caca00' : ($tour->statusCode == 1 ? 'red' : 'green')}}">{{$tour->statusText}}</div>
                            </div>

                            @if($tour->confirm == 1)
                                <div class="col-md-3 infoSec">
                                    <div class="infoVal">
                                        <button id="tourPublishButton" class="btn btn-{{$tour->statusCode == 1 ? 'success' : 'warning'}}" onclick="changeTourStatus()">{{$tour->statusCode == 1 ? 'تغییر به حالت انتشار' : 'تغییر به حالت پیش نویس'}}</button>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="col-md-12">
                                @foreach($tour->times as $time)
                                    <div class="row timeRow" style="height: auto">
                                        ...
                                        <div id="timeStatus_{{$time->id}}" class="col-md-2" style="color: {{$time->isPublished == 1 ? 'green' : 'red'}}">
                                            {{$time->isPublished == 1 ? 'قابل ثبت نام' : 'توقف ثبت نام'}}
                                        </div>
                                        <div class="col-md-2">
                                            <button class="btn btn-primary" style="font-size: 10px;" onclick="changeTimeStatus({{$time->id}})">تغییر وضعیت ثبت نام</button>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="row infoRow">
                            <div class="col-md-6 infoSec">
                                ...
                                <div class="infoVal" style="color: {{$tour->cancelAble == 1 ? 'green' : 'red'}}">{{$tour->cancelAble == 1 ? 'دارد' : 'ندارد'}}</div>
                            </div>
                ...
                <div>
                    ...
                    <div id="infoBody_2" class="infoBody">
                        <div class="row infoRow">
                            <div class="col-md-3 infoSec">
                                <div class="infoTitle" style="color: {{$tour->isTransport == 1 ? 'green' : 'red'}}; font-weight: bold;">{{$tour->isTransport == 1 ? 'حمل و نقل با تور است' : 'حمل و نقل با مسافر است'}}</div>
                            </div>
                        </div>
                        ...
                        <div class="row infoRow">
                            <div class="col-md-12 infoSec">
                                ...
                                <div class="infoVal" style="color: {{$tour->isMeal == 1 ? 'green' : 'red'}}">{{$tour->isMeal == 1 ? 'بر عهده تور' : 'ندارد'}}</div>
                                @if($tour->isMeal == 1)
                                    <div class="infoVal importantNote" style="margin-right: 20px;">{{$tour->isMealAllDay == 1 ? 'تمام روزهای تور' : 'بعضی روزها'}}</div>
                                @endif
                            </div>
                        ...
                        <div class="row infoRow">
                            ...
                            @if($tour->isTourGuide == 1)
                                ...
                                <div class="col-md-6 infoSec">
                                    <div class="infoTitle">آیا راهنمای تور شما تجربه‌ی مخصوصی برای افراد فراهم می‌آورد؟</div>
                                ...
                                <div class="col-md-6 infoSec">
                                    <div class="infoTitle">{{$tour->isTourGuideInKoochita == 1 ? 'نام کاربری' : 'نام و نام خانوادگی'}}</div>
                ...
                <div>
                    ...
                    <div id="infoBody_3" class="infoBody">
                        ...
                        <div class="row infoRow">
                            ...
                            <div class="col-md-3 infoSec">
                                <div class="infoVal importantNote" style="color: {{$tour->isInsurance == 1 ? 'green' : 'red'}}">{{$tour->isInsurance == 1 ? 'بیمه دارد' : 'بیمه ندارد'}}</div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                @foreach($tour->otherCost as $otherCost)
                                    <div class="row timeRow" style="height: auto">
                                        ...
                                        <div class="col-md-3">{{$otherCost->isFree == 1 ? 'رایگان' : $otherCost->cost . 'تومان'}}</div>
                                        <div class="col-md-3">{{$otherCost->inCapacity == 0 ? 'جز ظرفیت حساب نمی شود' : ''}}</div>
                                    </div>
                                @endforeach
                            </div>
                        </div>
