...
Calendar.prototype.create = function (_par) {
	...
	if (! _par) {
		...
		// a popup calendar.
		if($("#calendar-container-edit-placeDate").length && $("#calendar-container-edit-placeDate").css('visibility') != "hidden") {
			parent = document.getElementById("calendar-container-edit-placeDate");
		}
		else
	...
	if($("#calendar-container-edit-placeDate").css('visibility') != "hidden")
		div.classList = "calendar calendar2";
	else
