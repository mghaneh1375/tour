                ...
                <div class="cardsSection">
                    @if (count($myBusiness) == 0)
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <p>هیچ کسب و کاری موجود نیست. اولین کسب و کار خود را در کوچیتا ایجاد کنید.
                                    اگر در ایجاد کسب و کار مشکلی دارید از قسمت پشتیبانی مشکل خود را با ما درمیان بگذارید.
                                </p>
                            </div>
                        </div>
                    @else
