    ...
    <head>
        ...
        @section('header')
            ...
            <script>
                ...
                var BASE_URL = 'https://koochita-server.bogenstudio.com/api/';
                var TOKEN =
                    'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTg2ODgxNjcsInVzZXJfbmFtZSI6Imtvb2NoaXRhIiwiYXV0aG9yaXRpZXMiOlsiVVNFUiIsIkFETUlOIl0sImp0aSI6InR3RDdVT21KUGxQVS1LcFlaWW9hZlRsaEp4TSIsImNsaWVudF9pZCI6ImNsaWVudElkIiwic2NvcGUiOlsicm9sZV9hZG1pbiIsInJvbGVfdXNlciJdfQ.skfFJDWUwKjvlyfLLYFprT-Mj37BFU7cYK1q42MTD6aWVS8FP3fpIGAQOct0Bk1CbfNsNS-2_NHn73JvLWu4dr2pojnkk2fVgD2DeDp3enM8Ucw5NdgAQBOgaIdBgMu3yMbItYax_xB92fKQv_UnfUhBF1Y-yZfu4hoVPTPMdGUsmfYAQUakmeusS9mFfuraqTCFSWl8bMWg898NP0ebYckfy2-fxctK-jWv9Zf70q91IvZv1Ctjasjo7nhLUlmWBLKLOKyYnaQYlHA7cqM_EcOSF2T49_7S7Z99JvH8s27Irre1gH_WIMdsNgUOHvCkdhb9f-cZcWtEnVOhJzOTOQ';
            </script>
                    ...
                    <div class="left-custom-menu-adp-wrap">
                        ...
                        <ul class="nav navbar-nav left-sidebar-menu-pro">
                            @if (\Illuminate\Support\Facades\Auth::check())
                                <li>
                                    <a href="{{ route('home') }}" aria-expanded="false"><i
                                            class="fa big-icon fa-home"></i>
                                ...
                                <li class="nav-item"><a href="#" data-toggle="dropdown" role="button"
                                        aria-expanded="false" class="nav-link dropdown-toggle"><i
                                            ...
                                            onclick="document.location.href = '{{ url('asset') }}'"
                                            class="mini-dn">مدیریت
                                ...
                                <li class="nav-item"><a href="#" data-toggle="dropdown" role="button"
                                        aria-expanded="false" class="nav-link dropdown-toggle"><i
                                            class="fa big-icon fa-table"></i> <span class="mini-dn">گزارش گیری</span>
                                ...
                                <li class="nav-item"><a href="#" data-toggle="dropdown" role="button"
                                        aria-expanded="false" class="nav-link dropdown-toggle"><i
                                            class="fa big-icon fa-table"></i> <span class="mini-dn">پروفایل
                                            کاربری</span>
                                        <span class="indicator-right-menu mini-dn"><i
                                                class="fa indicator-mn fa-angle-left"></i></span></a>
                                    <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
