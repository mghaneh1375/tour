...
@section('head')
    ...
    <style>
        ...
        .equipmentSection .panel-title > div:hover, .equipmentSection .panel-title > div.selectTag{
            color: white;
            background: var(--koochita-light-green);
        }
    </style>
...
@section('script')
    ...
    <script>
        ...
        var prevStageUrl = "{{route('businessManagement.tour.create.stage_4', ['business' => $businessIdForUrl ,'tourId' => $tour->id])}}";
        var nextStageUrl = "{{route('businessManagement.tour.create.stage_6', ['business' => $businessIdForUrl ,'tourId' => $tour->id])}}";
    ...
    <script src="{{URL::asset('BusinessPanelPublic/js/tour/tourCreate_stage_5.js?v='.$fileVersions)}}"></script>
@endsection
