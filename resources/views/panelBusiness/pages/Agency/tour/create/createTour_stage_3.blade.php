                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-secondary active">
                            <input type="radio" name="isTransportTour" value="1"
                                onchange="showSection('tourMainTransports', this)" checked>
                            بله
                        </label>
                        <label class="btn btn-secondary">
                            <input type="radio" name="isTransportTour" value="0"
                                onchange="showSection('tourMainTransports', this)">
                            خیر
                        </label>
                    </div>
                </div>
                    ...
                    @if ($tour->isLocal)
                        <div id="sDiv" class="transportationDetailsMainBoxes">
                            ...
                            <div class="seperatorInWhiteSec"
                                style="width: 100%; direction: rtl; float: right; display: flex; flex-wrap: wrap;">
                                <div class="row" style="display: flex">
                                    <div class="inputBoxTour col-md-4 transportationStartTimeTourCreation" id="eTimeDiv"
                    ...
                    @else
                        <div id="sDiv" class="transportationDetailsMainBoxes">
                            ...
                            <div class="transportInfoSec">
                                <div>
                                    <div id="sTransportDiv" class="inputBoxTour col-md-4 transportationKindTourCreation"
                                    ...
                                    <div id="sTimeDiv" class="inputBoxTour transportationStartTimeTourCreation"
                                        style="margin-left: 15px;">
                                        <div class="inputBoxText">
                                            <div class="importantFieldLabel">ساعت حرکت</div>
                                        </div>

                                        <input type="text" id="sTime" class="inputBoxInput center clock"
                                ...
                                <div>
                                    <div class="inputBoxTour col-md-10" id="sAddressDiv" style="margin-left: 10px;">
                                        ...
                                        <input id="sAddress" class="inputBoxInput" type="text"
                                            placeholder="آدرس دقیق محل حرکت را وارد نمایید...">
                                    </div>
                                    <button type="button" class="transportationMapPinningTourCreation col-md-2"
                                        onclick="changeCenter('src')">نشانه‌گذاری بر روی نقشه</button>
                                    <input type="hidden" id="sLat" value="0">
                        ...
                        <div id="eDiv" class="transportationDetailsMainBoxes"
                            ...
                            <div class="row transportInfoSec">
                                <div>
                                    <div id="eTransportDiv" class="inputBoxTour col-md-4 transportationKindTourCreation"
                                        style="margin-left: 15px;">
                                        <div class="inputBoxText">
                                            <div class="importantFieldLabel">نوع وسیله</div>
                                        </div>
                                    ...
                                    <div class="inputBoxTour transportationStartTimeTourCreation" id="eTimeDiv"
                                        ...
                                        <input id="eTime" type="text" class="inputBoxInput center clock"
                                            placeholder="00:00" readonly>
                                    </div>
                                ...
                                <div>
                                    <div class="inputBoxTour col-md-10" id="eAddressDiv" style="margin-left: 10px;">
                                        ...
                                        <input id="eAddress" class="inputBoxInput" type="text"
                                            placeholder="آدرس دقیق محل بازگشت را وارد نمایید...">
                                    </div>
                                    <button type="button" class="transportationMapPinningTourCreation col-md-2"
                                        onclick="changeCenter('dest')">نشانه‌گذاری بر روی نقشه</button>
            ...
            <div class="whiteBox">
                ...
                <div class="row">
                    <div class="inputBoxTour col-md-12 relative-position" id="mainClassificationOfTransportationInputDiv">
                        ...
                        <div id="multiSelected" class="transportationKindChosenMainDiv multiSelected"
                            onclick="openMultiSelect(this)"></div>

                        <div id="multiselect" class="multiselect">
                            @foreach ($transport as $item)
                                <div class="optionMultiSelect" id="multiSelectTransport_{{ $item->id }}"
                                    onclick="chooseMultiSelectSideTransport({{ $item->id }})">
                                    {{ $item->name }}
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-secondary">
                            <input type="radio" name="isMeal" value="1"
                                onchange="showSection('mealsDiv', this)">بلی
                        </label>
                        <label class="btn btn-secondary active">
                            <input type="radio" name="isMeal" value="0" onchange="showSection('mealsDiv', this)"
                                checked>خیر
                        </label>
                    </div>
                </div>
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-secondary">
                                <input type="radio" name="isMealsAllDay" value="0"
                                    onchange="changeKindOfMeal(this.value)">چند روز خاص
                            </label>
                            <label class="btn btn-secondary active">
                                <input type="radio" name="isMealsAllDay" value="1"
                                    onchange="changeKindOfMeal(this.value)" checked>تمامی روزها
                            </label>
                        </div>
                            ...
                            <div>
                                @for ($i = 1; $i <= $tour->day; $i++)
                                    <div style="display: inline-block;">
                                        <div class="halfWidthDiv tourFoodMealTitleTourCreation">وعده ارائه شده برای روز
                                            {{ $i }}</div>
                                        <div class="halfWidthDiv tourFoodMealChoseTourCreation" style="display: flex">
                                            <div class="col-md-3" style="margin-left: 20px;">
                                                <input id="meals3_day_{{ $i }}"
                                                    name="meals_day_{{ $i }}" type="checkbox"
                                                    value="شام" />
                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-secondary">
                            <input type="radio" name="isBackUpPhone" value="0"
                                onchange="showSection('backUpPhoneDiv', this)">بلی
                        </label>
                        <label class="btn btn-secondary active">
                            <input type="radio" name="isBackUpPhone" value="1"
                                onchange="showSection('backUpPhoneDiv', this)" checked>خیر
                        </label>
                    </div>
                </div>
...
@section('script')
    ...
    <script>
        ...
        var prevStageUrl =
            "{{ route('businessManagement.tour.create.stage_2', ['business' => $businessIdForUrl, 'tourId' => $tour->id]) }}";
        var nextStageUrl =
