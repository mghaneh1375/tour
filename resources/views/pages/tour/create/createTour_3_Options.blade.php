...
{{--                </div>--}}
    ...
    <script>
        ...
        var prevStageUrl = "{{route('tour.create.stage.two', ['id' => $tour->id])}}";
        var nextStageUrl = "{{route('tour.create.stage.four', ['id' => $tour->id])}}";
        var storeStageThreeURL = '{{route("tour.create.stage.three.store")}}';
    </script>

    <script src="{{URL::asset('js/pages/tour/create/tourCreateStageThree.js?v='.$fileVersions)}}"></script>
