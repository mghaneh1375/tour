            ...
            <div class="whiteBox">
                ...
                <div class="InlineTourInputBoxesMainDiv">
                    <div class="inputBoxGeneralInfo inputBoxTour InlineTourInputBoxes" id="tourOriginInputBox">
                        ...
                        <input class="inputBoxInput" id="srcCity" type="text" placeholder="فارسی" readonly
                            onclick="chooseSrcCityModal()" value="{{ isset($tour->srcId) ? $tour->srcId : '' }}">
                        <input id="srcCityId" type="hidden" name="src"
                            value="{{ isset($tour->srcId) ? $tour->srcId : '' }}">
                    </div>
                </div>
                <div id="destDiv" class="InlineTourInputBoxesMainDiv">
                    <div class="inputBoxGeneralInfo inputBoxTour InlineTourInputBoxes tourDestinationInputBox">
                        ...
                        <input id="destInput" type="text" class="inputBoxInput" placeholder="فارسی"
                            onclick="chooseDestModal()" readonly>
                    ...
                    <div id="notSameTimeCalendarDiv" style="display: flex; flex-direction: column">
                        <div>
                            <div class="inputBoxTour col-xs-3 relative-position float-right" style="margin-left: 60px;">
                                ...
                                <input name="sDateNotSame[]" id="sDate_0" class="observer-example inputBoxInput"
                                    type="text">
                            </div>
                            ...
                            <div class="inputBoxTour col-xs-3 mg-rt-10 relative-position float-right">
                                ...
                                <input name="eDateNotSame[]" id="eDate_0" class="observer-example inputBoxInput"
                                    readonly />
                            </div>
                        </div>
                        ...
                        <div id="calendar_1" class="calendarRow">
                            <div class="inputBoxTour col-xs-3 relative-position float-right" style="margin-left: 60px;">
                                ...
                                <input name="sDateNotSame[]" id="sDate_1" class="observer-example inputBoxInput"
                                    type="text">
                            </div>
                            <div class="inputBoxTour col-xs-3 mg-rt-10 relative-position float-right">
                                <div class="inputBoxText">
                ...
                <div>
                    <div class="col-xs-4 float-right" style="margin-left: 50px;">
                        <div class="inputBoxTour">
                            ...
                            <input class="inputBoxInput" type="text" name="minCapacity" id="minCapacity"
                                placeholder="تعداد">
                        </div>
                    </div>
                    <div class="col-xs-4 float-right">
                        <div class="inputBoxTour">
                            ...
                            <input class="inputBoxInput" type="text" name="maxCapacity" id="maxCapacity"
                                placeholder="تعداد">
                        </div>
                    </div>
                ...
                <div class="nonGovernmentalTitleTourCreation">
                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        ...
                        <label class="btn btn-secondary active">
                            <input type="radio" name="private" value="0" id="option1" autocomplete="off"
                                checked>خیر
                        </label>
                    </div>
            ...
            <div class="whiteBox">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="checkbox" id="userInfoNeed_birthDay" name="userInfoNeed[]" value="birthDay"
                            checked />
                        ...
                        <input type="checkbox" id="userInfoNeed_meliCode" name="userInfoNeed[]" value="meliCode"
                            checked />
    ...
    <div id="timeRowSample" class="hidden">
        <div id="calendar_##number##" class="calendarRow">
            <div class="inputBoxTour col-xs-3 relative-position float-right" style="margin-left: 60px;">
                ...
                <input name="sDateNotSame[]" id="sDate_##number##" class="observer-example inputBoxInput"
                    type="text">
            </div>
            <div class="inputBoxTour col-xs-3 mg-rt-10 relative-position float-right">
                <div class="inputBoxText">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body" style="direction: rtl">
                    ...
                    <div class="row" style="display: flex; justify-content: space-between">
                        <div class="col-xs-4">
                            <div class="inputBoxTour relative-position mainClassificationOfPlaceInputDiv"
                                style="width: 100%">
                                <div class="inputBoxText" style="min-width: 60px;">
                                    <div>
                                        استان
                        ...
                        <div class="col-xs-4">
                            <div class="inputBoxTour col-xs-3 relative-position mainClassificationOfPlaceInputDiv"
                                ...
                                <select id="selectDestinationKind" class="inputBoxInput styled-select text-align-right"
                                    type="text">
                        ...
                        <div class="col-xs-4">
                            <div class="inputBoxTour  relative-position placeNameAddingPlaceInputDiv" style="width: 100%">
                                ...
                                <input id="inputSearchDestination" class="inputBoxInput text-align-right" type="text"
                                    onkeyup="searchForDestination(this)" />
                                <div class="searchResult"></div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script defer src="{{ URL::asset('BusinessPanelPublic/js/tour/create/tourCreate_stage_1.js?v=' . $fileVersions) }}">
    </script>
@endsection
