    ...
    <div>
        <div class="footerRside">
            <div id="aboutShazde" class="aboutShazdeMoreLess">
                ...
                <div>
                    <img id = 'nbqeesgtoeukfukzrgvjnbqe' style = 'cursor:pointer' onclick = 'window.open("https://logo.samandehi.ir/Verify.aspx?id=208632&p=uiwkobpdmcsigvkaxlaouiwk", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt = 'logo-samandehi' src = 'https://logo.samandehi.ir/logo.aspx?id=208632&p=odrflymaaqgwwlbqqftiodrf' />
                </div>
            </div>
