<div class="ui_columns is-multiline is-mobile reviewsAndDetails direction-rtlImp">
    ...
    <div id="detailsAndFeaturesMobile" class="ui_column is-4 details tabContent mahaliFoodSeperator topAndBottomBorderAndMargin {{$mainInfoClass}} hideOnPhone">
        <div class="direction-rtl featureOfPlaceMiddleContent row " style="margin: 0px">
            <div class="descriptionSections">
                ...
                <div class="row">
                    <div class="col-xs-6" style="float: right">
                        <div class="titleSection">
                            <div class="titlesPlaceDetail">
                                <span class="titleSectionSpan"> نوع غذا </span>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6" style="float: right">
                        <div class="titleSection">
                            <div class="titlesPlaceDetail">
                                <span class="titleSectionSpan"> نوع سرو </span>
                            </div>
                        </div>
                ...
                <div class="titleSection">
                    <div class="titlesPlaceDetail">
                        <span class="titleSectionSpan"> مناسب برای </span>
                    </div>
                </div>
                ...
                <div class="titleSection">
                    <div class="titlesPlaceDetail">
                        <span class="titleSectionSpan"> کالری </span>
                    </div>
                </div>
                ...
                @if($place->rice == 1)
                    <div class="contentSection col-xs-12"> برنج: 20 کالری در 1 قاشق غذاخوری </div>
                @endif
                @if($place->bread == 1)
                    <div class="contentSection col-xs-12"> نان: 40 کالری به اندازه ی هر کف دست </div>
                @endif
            </div>
        </div>
    </div>
    ...
    <div id="recepieForFood" class="ui_column is-8 generalDescription tabContent">
        <div class="block_header">
            <div class="titlesPlaceDetail">
                <h3 class="block_title"> دستورپخت : </h3>
            </div>
        </div>
    ...
    <div class="ui_column is-4 reviews tabContent hideOnTablet">
