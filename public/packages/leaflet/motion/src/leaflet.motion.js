...
L.Motion.Animate = {
    ...
    */
	motionStart: function () {
		if (this._map && !this.animation) {
	        ...
	        if(typeof this.motionOptions.Started === 'function')
                this.motionOptions.Started(this);
    ...
    */
    motionStop: function (animEnded) {
        ...
        if(typeof this.motionOptions.Ended === 'function')
            this.motionOptions.Ended(this);
    ...
    */
	motionPause: function () {
		if (this.animation) {
			...
			this.animation = null;
            if(typeof this.motionOptions.Paused === 'function')
                this.motionOptions.Paused(this);
    ...
    */
	motionResume: function () {
		if (!this.animation && this.__ellapsedTime) {
            ...
            if(typeof this.motionOptions.Resumed === 'function')
                this.motionOptions.Resumed(this);
